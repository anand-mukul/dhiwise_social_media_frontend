        ...
        <div className="flex flex-1 flex-col items-center justify-end md:ml-[0] ml-[65px] md:mt-0 mt-10 md:px-5 w-full">
          ...
          <div className="bg-white-A700 flex flex-col gap-[34px] justify-end mt-10 sm:pl-5 pl-[30px] py-[30px] rounded-[12px] w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-center justify-end ml-2.5 md:ml-[0] rounded-[12px] w-[99%] md:w-full">
              <Button
                className="flex h-[45px] items-center justify-center md:mt-0 my-2.5 rounded-[12px] w-[45px]"
              ...
              >
                <div className="blue_A700_light_blue_200_border border-2 border-solid md:h-[54px] h-[65px] p-[5px] relative rounded-[12px] w-full">
                  <Img
                ...
                <div className="blue_A700_light_blue_200_border2 border-2 border-solid md:h-[54px] h-[65px] p-[5px] relative rounded-[12px] w-full">
                  <Img
                    className="absolute h-[54px] inset-[0] justify-center m-auto object-cover rounded-[12px] w-[54px]"
                ...
                <div className="blue_A700_light_blue_200_border3 border-2 border-solid md:h-[54px] h-[65px] p-[5px] relative rounded-[12px] w-full">
                  <Img
                    className="absolute h-[54px] inset-[0] justify-center m-auto object-cover rounded-[12px] w-[54px]"
                ...
                <div className="blue_A700_light_blue_200_border4 border-2 border-solid md:h-[54px] h-[65px] p-[5px] relative rounded-[12px] w-full">
                  <Img
                    className="absolute h-[54px] inset-[0] justify-center m-auto object-cover rounded-[12px] w-[54px]"
                ...
                <div className="blue_A700_light_blue_200_border5 border-2 border-solid md:h-[54px] h-[65px] p-[5px] relative rounded-[12px] w-full">
                  <Img
                    className="absolute h-[54px] inset-[0] justify-center m-auto object-cover rounded-[12px] w-[54px]"
                ...
                <div className="blue_A700_light_blue_200_border6 border-2 border-solid md:h-[54px] h-[65px] p-[5px] relative rounded-[12px] w-full">
                  <Img
                    className="absolute h-[54px] inset-[0] justify-center m-auto object-cover rounded-[12px] w-[54px]"
              ...
              <div className="blue_A700_light_blue_200_border7 border-2 border-solid md:h-[54px] h-[65px] ml-5 md:ml-[0] pl-[5px] py-[5px] relative rounded-[12px] w-[7%] md:w-full">
                <Img
          ...
          <div className="bg-white-A700 flex flex-col items-start justify-start mt-[30px] p-[30px] sm:px-5 rounded-[12px] w-full">
              ...
              <div className="flex md:flex-col flex-row gap-[15px] items-center justify-between w-full">
                ...
                <div className="flex flex-col gap-[15px] items-center justify-start">
                  ...
                  <div className="flex flex-row gap-[15px] items-center justify-between w-full">
                    ...
                    >
                      <Button
                        className="cursor-pointer flex items-center justify-center min-w-[54px] my-1"
                        leftIcon={
                          <Img
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mt-10 w-full">
              ...
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[75px] md:ml-[0] ml-[482px]"
                rightIcon={
                  <Img
          ...
          <div className="bg-gray-900 flex sm:flex-1 flex-col gap-[45px] items-end justify-start p-[27px] sm:px-5 rounded-bl-[32px] rounded-tl-[32px] w-[97%] sm:w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-[63px] items-start justify-start mb-[41px] mr-[13px] pt-1 w-[97%] md:w-full">
              <div className="flex flex-row gap-2.5 items-center justify-start w-[53%] md:w-full">
                ...
                <Button
                  className="cursor-pointer font-inter min-w-[35px] text-center text-xs"
                  shape="round"
                  color="red_A200"
                  size="xs"
                  variant="fill"
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-5 justify-start w-full">
                    <div className="flex flex-row items-start justify-start w-full">
                      ...
                      <Button
                        className="flex h-[38px] items-center justify-center ml-[73px] my-[5px] rounded-[12px] w-[38px]"
                        color="white_A700_33"
                        size="lg"
                        variant="fill"
                      >
                    ...
                    <div className="flex flex-row gap-[15px] items-center justify-start ml-14 md:ml-[0] w-[48%] md:w-full">
                      <Button
                        className="cursor-pointer flex items-center justify-center min-w-[65px]"
                        leftIcon={
                          <Img
                ...
                >
                  <div className="flex flex-col items-center justify-start w-full">
                    <div className="flex flex-col gap-5 justify-start w-full">
                      ...
                      <Button
                        className="cursor-pointer flex items-center justify-center min-w-[80px] md:ml-[0] ml-[38px] mr-[197px]"
                        leftIcon={
                          <Img
                            className="h-3.5 ml-2.5 mr-1 my-2"
                            src="images/img_checkmark.svg"
